 ...
 */
add_action( 'storefront_header', 'storefront_product_search', 40 ); // esto se usa
//add_action( 'storefront_header', 'storefront_header_cart', 60 ); esto moverlo a template-hooks
